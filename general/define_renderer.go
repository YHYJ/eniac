...
var (
	...
	inactiveTabStyle  = lipgloss.NewStyle().Border(inactiveTabBorder, true).Padding(0, 2).BorderForeground(highlightColor)                                         // 不活跃标签页样式
	activeTabStyle    = inactiveTabStyle.Border(activeTabBorder, true).Padding(0, 3)                                                                               // 活跃标签页样式
