...
var GenealogyName = map[string]map[string]string{
	...
	"PackageTotalCount":  {"zh": "已安装包数量", "en": "Installed Package Total Count"},
	"AsExplicitCount":    {"zh": "单独指定安装包数量", "en": "As Explicit Package Count"},
	"AsDependencyCount":  {"zh": "作为依赖安装包数量", "en": "As Dependency Package Count"},
	...
	"PackageList":        {"zh": "可更新包列表", "en": "Package List"},
	"PackageQuantity":    {"zh": "可更新包数量", "en": "Package Quantity"},
}
